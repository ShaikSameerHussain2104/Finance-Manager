...
import { Loader2, LogIn, Phone, Lock } from "lucide-react"
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Submitting login form with:", { phoneNumber })
    ...
    >
      ...
      <Card className="w-full max-w-md border border-green-100 shadow-lg z-10 relative">
        ...
        <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-t-lg border-b border-green-100 pt-10">
          <CardTitle className="text-2xl text-center text-green-800">Login</CardTitle>
          <CardDescription className="text-center">Access your Masjid Finance Manager account</CardDescription>
        </CardHeader>
